...
const InstructorAccountStep = ({ setActiveStep }) => {
    ...
    const handleRegister = (e) => {
        ...
        if (!email.endsWith('@guc.edu.eg')) {
            setEmailError('* Please use your GUC instructor email');
        ...
        login(instructors[instructors.length - 1]);
        navigate('/');
    }
    ...
    return (
        <form onKeyDown={(e) => e.key === 'Enter' && handleRegister(e)} onSubmit={handleRegister} className='flex flex-col'>
            ...
            placeholder='your.name@guc.edu.eg'
...
export default InstructorAccountStep